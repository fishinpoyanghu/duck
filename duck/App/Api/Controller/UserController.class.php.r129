...
class UserController extends CommonController
{
    ...
    public function getUser(){
        if(IS_POST){
            $data = I('post.');
            $user = M('member')->field('id,account,status,token,realname,sex,nickname,phone,level,money,currency,action_code,dog_lev,machine,animal_num,wechat,alipay,enclosure_lev,references,egg_parent_status,machine_egg,machine_animal,one_clean,crean_time')->where(array('id'=>$this->userId))->find(); 
            if($user['one_clean']){
